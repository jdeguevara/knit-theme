...
if ( ! function_exists( 'knit_theme_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function knit_theme_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'knit-theme' ),
...
if ( ! function_exists( 'knit_theme_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'knit_theme_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function knit_theme_entry_footer() {
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'knit-theme' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'knit_theme_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function knit_theme_post_thumbnail() {
